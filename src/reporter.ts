...
export function generateEcosystemReport(dataPath: string): string {
  ...
  ln(`## Methodology`);
  ln();
  ln(`AgentGuard v2 scores agents across 5 independent layers with circuit breakers:`);
  ln();
  ...
  ln();
  ln(`---`);
  ln(`*Generated by [AgentGuard](https://github.com/Yonkoo11/agentguard) - Autonomous ERC-8004 Trust Scoring Agent*`);
